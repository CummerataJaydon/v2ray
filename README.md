...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/CummerataJaydon/v2ray) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为xxxxx，WS路径为$UUID-[vmess|vless|trojan|ss|socks]格式
...
* 端口：443
* 默认UUID：xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "websocket": {
        "enabled": true,
        "path": "/xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx-trojan",
